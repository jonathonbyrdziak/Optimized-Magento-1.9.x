 ...
 */
class Widgetized_Idpas400_Model_Sales_Quote_Address extends OnePica_AvaTax_Model_Sales_Quote_Address
{
    /**
...
//            var_dump($shippingRates);die;
             ...
             * CUSTOMIZED THIS FUNCTION BY ADDING THIS EVENT CALL
             */
            Mage::dispatchEvent($this->_eventPrefix . '_update_shipping_rates', array(
                $this->_eventObject => $this,
