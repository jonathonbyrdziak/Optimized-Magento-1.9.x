...
class Fooman_SpeedsterAdvanced_Block_Page_Html_Head extends Mage_Page_Block_Html_Head
{
    ...
    )
    {
        ...
        foreach ($skinItems as $params => $rows) {
            foreach ($rows as $name) {
                $relativeUrl = Mage_Core_Model_Store::URL_TYPE_SKIN.DS.str_replace(Mage::getBaseUrl(Mage_Core_Model_Store::URL_TYPE_SKIN), '', $designPackage->getSkinUrl($name, array()));
